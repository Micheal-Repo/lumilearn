  ...
  return (
    <>
      ...
      <aside className="h-screen w-[3rem] border-r border-border relative z-20 bg-background md:hidden">
       ...
       {isOpen && <div className="absolute w-[100vw] bg-black/50 top-0 left-0 h-screen z-10"/>
       } 
       
        <div
          className={cn(
            "absolute top-0 left-0 h-screen z-20 w-[calc(100vw-3rem)] border-r border-border bg-red-200 transition-all duration-300",
            isOpen ? "translate-x-[3rem]" : "-translate-x-[100%]"
          )}
        >
        </div>

        <div className="relative z-30 bg-blue-100 flex justify-center py-4">
